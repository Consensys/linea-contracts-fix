...
contract PlonkVerifier {
  ...
  uint256 private constant vk_selector_commitments_commit_api_0_x = 3884624064879507288554125065509059886567955998027552754695080199794317463496;
  uint256 private constant vk_selector_commitments_commit_api_0_y = 3095893745686259387023328325251031582843387681306303361911851672293653329255;
  ...
  public view returns(bool success) {
    ...
    assembly {
      ...
      function compute_gamma_kzg(aproof) {
        ...
        let size_input := add(0x17, mul(vk_nb_commitments_commit_api,3)) // number of 32bytes elmts = 0x16 (zeta+z(zeta*omega)+2*7+7 for the digests+openings) + 2*vk_nb_commitments_commit_api (for the commitments of the selectors) + vk_nb_commitments_commit_api (for the openings of the selectors)
