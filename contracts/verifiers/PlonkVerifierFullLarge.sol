...
/// @title Plonk verifier template.
/// @author Thomas Piellard
/// @notice Supports verifying Plonk proofs, with specialised custom gates 
/// dedicated to perform efficient Fiat Shamir in-circuit.
contract PlonkVerifier {
  ...
  public view returns(bool success) {
    ...
    assembly {
      ...
      /// not reduced, and the commitment to the grand product polynomial 
